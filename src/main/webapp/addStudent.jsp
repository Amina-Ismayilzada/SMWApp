...
<div class="container">
    ...
    <form  action="/WebApps/student-servlet?action=addStudent" method="POST">
        ...
        <button type="submit" class="btn btn-primary btn-lg btn-block">Click to add student</button>
    </form>
